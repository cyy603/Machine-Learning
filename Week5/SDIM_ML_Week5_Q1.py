...
if __name__ == '__main__':
    ...
    momentum = 0.04
    epoch = 350
    train_X, train_y = read_data('E:\\chen yuanyao\\Machine Learning\\SDM\\Week5\\Homework5\\data\\Digits\\mnist\\train')
    test_X, test_y = read_data('E:\\chen yuanyao\\Machine Learning\\SDM\\Week5\\Homework5\\data\\Digits\\mnist\\test')
